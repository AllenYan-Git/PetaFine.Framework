...
namespace Infrastructure
{
    ...
    public class StringUtil
    {
        ...
        /// <returns></returns>
        public static string GetDateTimeBegin(DateTime dateTime)
        {
        ...
        /// <param name="dateTime"></param>
        /// <returns></returns>
        public static string GetDateTimeEnd(DateTime dateTime)
        {
        ...
        /// <returns></returns>
        public static string UnitConversion(decimal fileSize)
        {
            if (fileSize < 1024)
                return fileSize + "B";
            ...
            if (fileSize < 1024 * 1024 * 1024)
                return (fileSize / (1024 * 1024)).ToString("0.00") + "M";
            if (fileSize < (long)1024 * 1024 * 1024 * 1024)
                return (fileSize / ((long)1024 * 1024 * 1024 * 1024)).ToString("0.00") + "GB";
            if (fileSize >= (long)1024 * 1024 * 1024 * 1024)
                return (fileSize / ((long)1024 * 1024 * 1024 * 1024)).ToString("0.00") + "TB";
            return "";
        }
    }
}
